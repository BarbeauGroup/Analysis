...
void makePlots(){
	...
	outlier_ce_qfVal[0] = out_yield[0] / outlier_br[0] * 100.;
	double out_ce_qfHighErr[1];
	out_ce_qfHighErr[0] = out_yield_HighErrs[0] / outlier_br[0] * 100.;
	double out_ce_qfLowErr[1];
	out_ce_qfLowErr[0] = out_yield_LowErrs[0] / outlier_br[0] * 100.;
