...
// For simple crystal detectors with natural abundances.
  isotopes["CeBr3"].push_back("Ce140");
  molar_fraction["CeBr3"].push_back(0.22125);
  isotopes["CeBr3"].push_back("Ce142");
  molar_fraction["CeBr3"].push_back(0.02875);
  isotopes["CeBr3"].push_back("Br79");
  molar_fraction["CeBr3"].push_back(0.3825);
  isotopes["CeBr3"].push_back("Br81");
  molar_fraction["CeBr3"].push_back(0.3675);
